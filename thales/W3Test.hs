...
ex16_rgb_complicated = property $ do
  vs <- replicateM 6 (choose (0,1))
  vs' <- replicateM 2 (choose (0,0.1 :: Double))
  let [r0,b0,g0,r1,b1,g1] = vs
      [x, y] = vs
      c0 = Darken x (Mix (Darken (1-r0) Red) (Mix (Darken (1-b0) Blue) (Darken (1-g0) Green)))
